<h1 align="center">Hi 👋, I'm Megumin</h1><p align="center">
...
flowchart LR
  U[User/Browser] --> FE[Frontend: React, Next.js, Vue, TypeScript, Tailwind]
  FE --> BE[Backend: Node.js (TypeScript), Python, Go, PHP]
  BE --> DB[(Database: MongoDB / PostgreSQL)]
  BE --> AUTH[Auth (JWT)]
  BE --> CACHE[Redis]
  BE --> MSG[Background Jobs / Workers]
  BE --> CI[CI/CD: GitHub Actions]
